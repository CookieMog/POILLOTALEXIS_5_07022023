...
function store_comment()
{
    ...
    if (isset($_POST) && !empty($_POST)) {
        ...
        if (strlen($commentText) > 255) {
            ...
            $id = $_POST['id'];
            /* header("Location: http://projet5/index.php?action=add-comment&id=$id"); */
            return;
        }
        ...
        /* header("Location: http://projet5/index.php?action=article&id=$id"); */
    }
};
...
function delete_comment()
{
    ...
    if ($res) {
        ...
        /*  header("Location: http://projet5/index.php?action=moderation"); */
    } else {
        /* header("Location: http://projet5/index.php?action=admin"); */
